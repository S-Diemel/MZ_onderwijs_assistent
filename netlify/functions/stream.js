// Endpoint (per netlify.toml below): /api/openai/stream
...
export default async (request, context) => {
  try {
    ...
    const OPENAI_API_KEY = context.env.get("OPENAI_API_KEY");
    const VECTOR_STORE_ID = context.env.get("VECTOR_STORE_ID");
