...
def custom_rag(user_input):
    imce_instructions = (
        ...
        •	Bronvermelding: geef altijd een voor een een bronvermelding met de bestandsnamen (.docx, .pdf, .txt, etc.) van de gebruikte bronnen aan het einde van je antwoord. 
