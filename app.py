...
def custom_rag(user_input):
    assistant_instructions = (
        ...
        •	Bronvermelding: geef altijd een bronvermelding met de volledige en precieze bestandsnamen (.docx, .pdf, .txt, etc.) van de gebruikte bronnen aan het einde van je antwoord. 
